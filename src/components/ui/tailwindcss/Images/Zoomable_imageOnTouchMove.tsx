  ...
  return (
    ...
    >
      <Image
        ...
        width={width}
        height={height}
        className={`w-full h-auto object-cover rounded-lg shadow-md  aspect-square cursor-pointer transition-transform duration-300 ease-out ${isHovered ? "scale-150" : "scale-100"}`}
        style={{
...
export default Zoomable_imageOnTouchMove;
